...
fn union(a: &Counter, b: &Counter) -> Counter {
...
fn intersection(a: &Counter, b: &Counter) -> Counter {
...
fn gcd(m: u64, n: u64, primes: &Primes) -> Option<u64> {
...
fn lcm(m: u64, n: u64, primes: &Primes) -> Option<u64> {
    if m == 0 || n == 0 {
        return Some(0)
    }
...
fn primes_under(max: u64) -> Primes {
...
fn factors(n: u64, primes: &Primes) -> Option<Counter>{
